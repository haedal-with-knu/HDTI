...
### ARCI : 에디슨형
> * 캐릭터 - 사스미  
> * 이 유형의 사람들을 떠올리자면 교수가 생각난다. 학점은 안 봐도 3점대 후반에서 4점대 사이이다. 아직 프로그래밍 언어의 사용이나 웹개발 등에 미숙할 수 있으나 기본적으로 뭐든 열심히 하기 때문에 빠른 기간 내의 실력 상승이 기대된다. 개발하는 것을 좋아하고, 코드나 문서 작성 시에도 주석을 하나하나 달아가며 누가 보더라도 쉽게 이해가도록 노력하는, 크게 될 상이니 앞으로 가까이 하도록 하자. 
### ARCP : 극한의 효율형
캐릭터 - 해달이  
